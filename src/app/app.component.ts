  ...
  showReferencesDialog() {
    const settings = {
      ...
      htmlContent: `<ul>
                      ...
                      <li>4. Gore RM, Pickhardt PJ, Mortele KJ, Fishman EK, Horowitz JM, Fimmel CJ, Talamonti MS, Berland LL, Pandharipande PV. Management of Incidental Liver Lesions on CT: A White Paper of the ACR Incidental Findings Committee. J Am Coll Radiol. 2017 Nov; 14(11):1429-1437. Epub 2017 Sep 18.</li>
                    </ul>`,
